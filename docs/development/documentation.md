...
- [Diataxis](https://diataxis.fr/) 按读者需求区分教程、操作指南、参考和解释；本仓库按玩家、贡献者、仓库维护者和
  具体模块维护者拆分文档入口。
...
`docs/development/README.md`、`tools/README.md` 或 `templates/README.md`；具体 Mod 的玩家 README 保持面向使用者。
...
模板只描述新项目的初始骨架。现有项目的真实构建和组包约定以项目文件、`Taiwu.Mod.Pack.proj`、目录 README 和解决方案
注册为准。
