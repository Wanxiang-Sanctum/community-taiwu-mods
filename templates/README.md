...
这些模板只描述新项目的初始骨架。Mod 模板会生成面向玩家的 `README.md` 和面向源码维护者的 `DEVELOPMENT.md`；现有项目的
...
面向玩家的 README 模板只生成最小入口：说明这是哪个 Mod，并指向源码维护文档。具体功能、安装方式、品牌表达、发布文案、
兼容性和信息结构由具体 Mod 按自己的读者、发布渠道和维护习惯组织，不在模板中预设填空结构。

- `templates/mod/README.md.scriban` 生成面向玩家的最小入口。
