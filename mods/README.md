...
| `Wanxiang.Guanxiangtai/` | 面向太吾 Mod 制作者的本机 MCP 服务；当前提供 MCP server 启动、鉴权、HTTP 入口登记、前后端插件状态检测和受信 C# 脚本执行。                            | `Wanxiang.Guanxiangtai/README.md` | `Wanxiang.Guanxiangtai/DEVELOPMENT.md` |
