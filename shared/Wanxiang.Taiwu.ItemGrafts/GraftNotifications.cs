...
public static class GraftNotifications
{
    public const short DefaultNativeRecordType = 254;
        ...
        short nativeRecordType = DefaultNativeRecordType)
    {
        ...
        _ = ValidateNativeRecordType(nativeRecordType, nameof(nativeRecordType));
    ...
    private static InstantNotificationItem ValidateNativeRecordType(
